(function (window, $, mw) {
    ...
    function updateRC() {
        $.getJSON(mw.config.get('wgServer') + '/api.php?action=query&list=recentchanges&rclimit=10&rctype=edit&rcprop=user|timestamp|title|ids&format=json', function (data) {
